...
const LiveProcess = () => {
  const [activeStep, setActiveStep] = useState(2); // Start at "Verifying identity"
        ...
        <div className="flex-1 lg:max-w-xl">
          ...
          <div className="flex items-center gap-6">
            <div className="flex -space-x-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="w-12 h-12 rounded-full border-2 border-primary bg-slate-200 flex items-center justify-center overflow-hidden">
