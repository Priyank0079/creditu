...
const LoanProducts = () => {
      ...
      gsap.fromTo(cardsRef.current, 
        { x: 100, opacity: 0 },
        {
          ...
          scrollTrigger: {
            ...
            start: 'top 80%', // Changed from 75% to 80%
          },
        }
      );
  ...
  return (
    <section id="loans" ref={sectionRef} className="py-20 bg-background overflow-hidden">
            ...
            >
              ...
              <div className="space-y-6 pt-6 border-t border-white/10">
                <div className="flex justify-between items-center">
                  <span className={`${product.active ? 'text-white/60' : 'text-textSecondary'} text-sm font-bold uppercase tracking-wider`}>
                    Max Limit
                  </span>
