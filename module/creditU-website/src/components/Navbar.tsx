    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <img src="/images/image.png" alt="creditU" className="h-10 w-auto" />
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button className="btn-premium btn-primary py-3">
          ...
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-slate-100">
                <button className="text-primary font-bold py-3 text-left">Login</button>
                <button className="btn-premium btn-primary py-3 w-full">
                  Get Started <ArrowRight size={18} />
                </button>
              </div>
            </div>
